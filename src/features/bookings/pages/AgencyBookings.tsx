          ...
          {bookings.length > 0 ? (
            <div className="space-y-3 sm:space-y-4">
              {bookings.map((booking) => (
                <div key={booking.id} className="flex flex-col gap-3 p-3 sm:p-4 border border-border rounded-lg hover:bg-muted transition-colors">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4">
                    ...
                    <div className="flex flex-col sm:items-end gap-2 sm:gap-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button size="sm" variant="outline" className="border-border hover:bg-muted text-xs px-2 py-1 gap-1">
